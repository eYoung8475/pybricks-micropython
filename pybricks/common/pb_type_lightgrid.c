...
// pybricks._common.LightGrid.set_orientation
STATIC mp_obj_t common_LightGrid_set_orientation(size_t n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(common_LightGrid_set_orientation_obj, 1, common_LightGrid_set_orientation);
...
STATIC const mp_rom_map_elem_t common_LightGrid_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_set_orientation), MP_ROM_PTR(&common_LightGrid_set_orientation_obj) },
